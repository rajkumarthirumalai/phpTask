...
<body>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <div class="d-flex">
                                <form id="deleteForm_<?php echo $id; ?>" method="post" action="delete_user.php" onsubmit="return confirm('Are you sure you want to delete this user?');">
                                    <input type="hidden" name="id" value="<?php echo $id; ?>">
                                    <a href="#" onclick="deleteUser(<?php echo $id; ?>)"><i class="fas fa-trash fa-lg" style="color: red;"></i></a>
                                </form>
                                <a href="view_user.php?id=<?php echo $id; ?>"><i class="fas fa-info-circle fa-lg px-3" style="color: blue;"></i></a>
                            </div>
    ...
    <script>
        function sortUsers(select) {
            ...
            window.location.href = "user_management.php?sort=" + sortCriteria;
        }
    </script>
</body>
